...
start = int(input("Welcome to Codely! Make sure you have opened this in fullscreen! Here you browse files or play games! Press 1 + Enter to continue ...   "))
if start == 1:
    print("="*150)

time.sleep(1)
print("Instructions: You need to have Windows 10 or 11. In the blank space you need to write the code for the thing you want to open.") 
...
print("Codely is made by Leonxzy. For any technical issues or bugs, contact: leonhodzic44@gmail.com ")
