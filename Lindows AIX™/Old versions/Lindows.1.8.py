...
if source == "test":
    print("This is test mode. No reminders will be set.")
    ...
    if timeenter in [5, 10, 15, 20, 30, 60]:
        ...
        print("You entered an invalid time. Please try again.")
        exit()
...
print("Lindows is made by Leonxzy. For any technical issues or bugs, contact: leonhodzic44@gmail.com ")
