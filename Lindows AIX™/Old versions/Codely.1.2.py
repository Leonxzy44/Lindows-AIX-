...
start = int(input("Welcome to Codely! Here you browse files or play games! Press 1 + Enter to continue ...   "))
if start == 1:
    print("="*150)

time.sleep(1)
print("Instructions: You need to have windows 10 or 11. In the blank space you need to write the code for thing you want to open. ")

time.sleep(1)

source = input("| Hacking snake game [Code: snk] | Calculator [Code: cal ] | Enter your source code here:  ")
print("="*150)
...
print("This script is made by Leonxzy. For any technical issues or bugs, contact: leonhodzic44@gmail.com ")

time.sleep(1)

cmnt = int(input("Do you want to comment or suggest on this game? (Press 1 + ENTER for YES | 2 + ENTER for NO): "))

if cmnt == 1 : 

    cmnt = int(input("Enter your comment or suggestion here ---> "))
